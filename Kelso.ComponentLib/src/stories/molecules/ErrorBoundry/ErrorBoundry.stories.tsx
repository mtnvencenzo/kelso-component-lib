...
import ErrorBoundry from 'src/lib/components/molecules/ErrorBoundry/ErrorBoundry';

const ProblemComponent = () => {
    throw new Error('Bad component');
}

const meta: Meta<typeof ErrorBoundry> = {
    title: 'Components/Molecules/ErrorBoundry',
